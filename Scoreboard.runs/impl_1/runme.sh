...
HD_PWD='C:/Users/marco/Documents/Vivado/Scoreboard/Scoreboard.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Scoreboard_Final.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Scoreboard_Final.tcl -notrace
